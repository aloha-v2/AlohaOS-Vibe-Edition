...
unsafe extern "C"{fn aloha_syscall_entry();fn aloha_resume_user(frame:*const SyscallFrame,path:u64,code_selector:u64,data_selector:u64);static mut ALOHA_SYSCALL_KERNEL_STACK:u64;static mut ALOHA_SYSCALL_KERNEL_RETURN_RSP:u64;static mut ALOHA_SYSCALL_PROCESS:u64;}
...
pub fn uninstall_process(){unsafe{ptr::write_volatile(&raw mut ALOHA_SYSCALL_KERNEL_RETURN_RSP,0);ptr::write_volatile(&raw mut ALOHA_SYSCALL_KERNEL_STACK,0);ptr::write_volatile(&raw mut ALOHA_SYSCALL_PROCESS,0);}}

//! Allocation-free COM1 logger protected by an IRQ-safe spinlock.
...
/// Best-effort panic output bypasses the lock because a panic may have
/// interrupted formatting while the serial guard was held.
